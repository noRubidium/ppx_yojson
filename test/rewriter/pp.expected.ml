...
let patterns =
  ((function
    ...
    | _s as _var -> ()
    | `Assoc (("a", _a)::_::_::("b", `Int 1)::_)
      |`Assoc (_::("a", _a)::_::("b", `Int 1)::_)
      |`Assoc (("a", _a)::_::("b", `Int 1)::_)
      |`Assoc (_::_::("a", _a)::("b", `Int 1)::_)
      |`Assoc (_::("a", _a)::("b", `Int 1)::_)
      |`Assoc (("a", _a)::("b", `Int 1)::_)
      |`Assoc (("b", `Int 1)::_::_::("a", _a)::_)
      |`Assoc (_::("b", `Int 1)::_::("a", _a)::_)
      |`Assoc (("b", `Int 1)::_::("a", _a)::_)
      |`Assoc (_::_::("b", `Int 1)::("a", _a)::_)
      |`Assoc (_::("b", `Int 1)::("a", _a)::_)
      |`Assoc (("b", `Int 1)::("a", _a)::_) -> ()
    | `Assoc (_::_::_::("a", _a)::_)|`Assoc (_::_::("a", _a)::_)
      |`Assoc (_::("a", _a)::_)|`Assoc (("a", _a)::_) as _var -> ()
    | _ as _any -> ())
  [@warning "-11"])
